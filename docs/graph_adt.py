...
class GraphADT:
    ...
    def save_plot(self):
        ...
        self.plot()
        plt.savefig('../images/saved_graph.png', bbox_inches='tight')
        plt.clf()
        # plt.plot(x, y)
    ...
    def reveal(self, axes=True, save=False):
        ...
        plt.savefig('../images/prediction.png', bbox_inches='tight')
        print('Saved reveal to ../images/prediction.png!')
        plt.clf()
        # plt.show()
    ...
    def simple_reveal(self, save=False):
        ...
        self.plot()
        plt.savefig('../images/prediction.png', bbox_inches='tight')
        print('Regression saved ot prediction.png!')
        plt.clf()
        # plt.show()
